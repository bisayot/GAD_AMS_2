...
class AccomplishmentReportController extends BaseController
{
    ...
    public function index()
    {
        ...
        $active = $db->table('accomplishment_report as ar')
            ->select('ar.id, ar.status, cn.control_number as control, ar.activity_title as title, DATE_FORMAT(ar.created_at, "%Y-%m-%d") as date, users.username as office, ad.form_type as formLabel')
        ...
        $archived = $db->table('archived_accomplishment_reports as aar')
            ->select('aar.original_report_id as id, aar.status, cn.control_number as control, aar.activity_title as title, DATE_FORMAT(aar.created_at, "%Y-%m-%d") as date, users.username as office, ad.form_type as formLabel')
