<?php
// twg/archive.php - Archive for TWG (Approved Activity Designs & Completed Reports Only)
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bg-gradient-purple { background: linear-gradient(135deg, #990dd1 0%, #b979cc 100%); }
        ...
        /* Status Badges - Archive (Approved, Completed) */
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 4px 12px rgba(153, 13, 209, 0.08);
        }
        .stat-card.purple {
            background: linear-gradient(135deg, #990dd1 0%, #b979cc 100%);
            color: white;
        ...
        .stat-icon { float: right; font-size: 2rem; opacity: 0.15; }
        .stat-label {
            font-size: 0.7rem;
            font-weight: 700;
        ...
        .stat-number { font-size: 2rem; font-weight: 800; color: #1a1a2e; line-height: 1; }
        .stat-sub { font-size: 0.65rem; color: #6c757d; margin-top: 0.5rem; }
    ...
    <main class="ml-64 min-h-screen">
        <div class="p-8">
            ...
            <div class="grid grid-cols-3 gap-4 mb-8">
                ...
                <div class="stat-card">
                    <div class="stat-icon">✅</div>
                    <div class="stat-label">Approved Designs</div>
                    <div class="stat-number">5</div>
                    <div class="stat-sub">Approved activity designs</div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon">🎉</div>
                    <div class="stat-label">Completed Reports</div>
                    <div class="stat-number">3</div>
                    <div class="stat-sub">Completed accomplishment reports</div>
                </div>
            </div>
            ...
            <div class="mb-6 border-b border-slate-200">
                <div class="flex gap-2">
                    <a href="?tab=designs" class="tab-btn <?php echo (!isset($_GET['tab']) || $_GET['tab'] === 'designs') ? 'tab-active' : 'tab-inactive'; ?>">
                        Activity Designs
                        <span class="ml-2 text-[10px] bg-gradient-to-r from-[#990dd1]/20 to-[#b979cc]/20 text-[#990dd1] px-2 py-0.5 rounded-full">5</span>
                    </a>
            ...
            <div class="data-table">
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody>
                            <?php
                            // Archived Activity Designs (Approved Only)
                            $archivedDesigns = [
                                ['id' => 1, 'control' => "GAD-2026-001", 'title' => "Lorem ipsum dolor sit amet", 'date' => "Jan 15, 2026", 'dateRaw' => "2026-01-15", 'status' => "approved", 'statusText' => "Approved", 'statusClass' => "status-approved", 'type' => "design", 'link' => "design_view.php?id=1"],
                                ['id' => 2, 'control' => "EMP-2026-001", 'title' => "Lorem ipsum dolor sit amet", 'date' => "Jan 20, 2026", 'dateRaw' => "2026-01-20", 'status' => "approved", 'statusText' => "Approved", 'statusClass' => "status-approved", 'type' => "design", 'link' => "design_view.php?id=2"],
                                ['id' => 3, 'control' => "INSET-2026-001", 'title' => "Lorem ipsum dolor sit amet", 'date' => "Jan 25, 2026", 'dateRaw' => "2026-01-25", 'status' => "approved", 'statusText' => "Approved", 'statusClass' => "status-approved", 'type' => "design", 'link' => "design_view.php?id=3"],
                                ['id' => 4, 'control' => "EXT-2026-001", 'title' => "Lorem ipsum dolor sit amet", 'date' => "Jan 10, 2026", 'dateRaw' => "2026-01-10", 'status' => "approved", 'statusText' => "Approved", 'statusClass' => "status-approved", 'type' => "design", 'link' => "design_view.php?id=4"],
                                ['id' => 5, 'control' => "GAD-2025-015", 'title' => "Lorem ipsum dolor sit amet", 'date' => "Dec 15, 2025", 'dateRaw' => "2025-12-15", 'status' => "approved", 'statusText' => "Approved", 'statusClass' => "status-approved", 'type' => "design", 'link' => "design_view.php?id=5"]
                            ];

                            // Archived Accomplishment Reports (Completed Only)
                            $archivedReports = [
                                ['id' => 1, 'control' => "ACC-GAD-2026-001", 'title' => "Lorem ipsum dolor sit amet - Accomplishment Report", 'date' => "Feb 15, 2026", 'dateRaw' => "2026-02-15", 'status' => "completed", 'statusText' => "Completed", 'statusClass' => "status-completed", 'type' => "report", 'link' => "ar_view.php?id=1"],
                                ['id' => 2, 'control' => "ACC-EMP-2026-001", 'title' => "Lorem ipsum dolor sit amet - Accomplishment Report", 'date' => "Feb 20, 2026", 'dateRaw' => "2026-02-20", 'status' => "completed", 'statusText' => "Completed", 'statusClass' => "status-completed", 'type' => "report", 'link' => "ar_view.php?id=2"],
                                ['id' => 3, 'control' => "ACC-EXT-2026-001", 'title' => "Lorem ipsum dolor sit amet - Accomplishment Report", 'date' => "Feb 10, 2026", 'dateRaw' => "2026-02-10", 'status' => "completed", 'statusText' => "Completed", 'statusClass' => "status-completed", 'type' => "report", 'link' => "ar_view.php?id=3"]
                            ];
                            ...
                            $sourceData = ($currentTab === 'designs') ? $archivedDesigns : $archivedReports;
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center gap-2">
                                            ...
                                            <p class="text-[#6c757d] text-[13px]">No archived records found</p>
                            ...
                            ?>
                                <tr class="clickable-row" onclick="window.location.href='<?php echo $item['link']; ?>'">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-[13px] text-[#6c757d]"><?php echo htmlspecialchars($item['date']); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
