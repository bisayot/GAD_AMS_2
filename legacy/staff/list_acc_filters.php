<?php
// staff/list_acc_filters.php - Accomplishment Reports List with Clickable Rows
require_once '../auth.php';
require_role(['gad_staff', 'admin']);
$page_title = 'List & Filters | Accomplishment Reports';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>List & Filters | Accomplishment Reports | GAD-IMS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card.green { background: linear-gradient(135deg, #2e7d32 0%, #43a047 100%); color: white; }
        .stat-card.green .stat-label, .stat-card.green .stat-sub { color: rgba(255,255,255,0.8); }
        ...
        /* Header Icon */
        .header-icon { width: 48px; height: 48px; background: linear-gradient(135deg, #2e7d32 0%, #43a047 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 24px; color: white; }
...
<body>
    <header class="staff-header">
        <div>
            <h2 class="header-title">Accoplishment Report List</h2>
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        <?php
                        $reports = [
                            ['control' => 'EMP-2026-003', 'title' => 'Excepteur sint occaecat cupidatat', 'office' => 'College of Nursing', 'form' => 'employee', 'formLabel' => 'Employee Training', 'formClass' => 'form-badge-employee', 'date' => 'Mar 10, 2026', 'status' => 'For Revision', 'statusClass' => 'badge-red', 'link' => 'ar_revision.php?id=6'],
                            ['control' => 'INSET-2026-003', 'title' => 'Sunt in culpa qui officia deserunt', 'office' => 'College of Science', 'form' => 'inset', 'formLabel' => 'INSET', 'formClass' => 'form-badge-inset', 'date' => 'Mar 1, 2026', 'status' => 'For Revision', 'statusClass' => 'badge-red', 'link' => 'ar_revision.php?id=10'],
                            ['control' => 'EXT-2026-002', 'title' => 'Sed do eiusmod tempor labore', 'office' => 'College of Agriculture', 'form' => 'extension', 'formLabel' => 'Extension', 'formClass' => 'form-badge-extension', 'date' => 'Feb 5, 2026', 'status' => 'For Review', 'statusClass' => 'badge-yellow', 'link' => 'ar_review.php?id=13'],
                            ['control' => 'GAD-2026-004', 'title' => 'Voluptate velit esse cillum', 'office' => 'Office of Student Services', 'form' => 'employee', 'formLabel' => 'Employee Training', 'formClass' => 'form-badge-employee', 'date' => 'Mar 22, 2026', 'status' => 'For Review', 'statusClass' => 'badge-yellow', 'link' => 'ar_review.php?id=18'],
                            ];
                ...
                <div class="pagination">
                    <div class="pagination-info">Showing <strong>1</strong> - <strong>7</strong> of <strong>7</strong> reports</div>
