...
<body>
        ...
        <div style="padding: 32px;">
            <div style="margin-bottom: 32px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                    <span style="font-size: 36px; color: #990dd1;">👤</span>
                    <h1 style="font-size: 24px; font-weight: 700; color: #000;">Assign Mandates</h1>
                </div>
                <p style="color: #3b3b3b; font-size: 11px;">Assign GAD mandates to accomplishment reports</p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 32px;">
                ...
                <div style="background-color: white; border-radius: 12px; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); border: 1px solid #e2e8f0; overflow: hidden;">
                    <div style="padding: 20px; border-bottom: 1px solid #e2e8f0; background-color: #f8fafc;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <h2 style="font-weight: 700; color: #000; display: flex; align-items: center; gap: 8px; font-size: 11px;">
                                <span style="font-size: 24px; color: #990dd1;">📊</span> Accomplishment Reports
                            </h2>
                            <div style="position: relative;">
                                <select id="reportFilter" style="font-size: 11px; border: 1px solid #e2e8f0; border-radius: 8px; padding: 6px 12px; background-color: white;">
                        ...
                        <p style="font-size: 10px; color: #3b3b3b; margin-top: 4px;">Select an accomplishment report to assign mandates</p>
                    </div>
                    <div style="max-height: 500px; overflow-y: auto;">
                        <div id="reportsList" style="display: flex; flex-direction: column;">
                            <div style="padding: 24px 40px; text-align: center; color: #3b3b3b; font-size: 11px;">Loading accomplishment reports...</div>
                        </div>
                    </div>
                    <div style="padding: 16px; border-top: 1px solid #e2e8f0; background-color: rgba(248,250,252,0.5); display: flex; justify-content: space-between; align-items: center;">
                        <p id="reportsCount" style="font-size: 10px; color: #3b3b3b;">0 reports found</p>
                ...
                <div style="background-color: white; border-radius: 12px; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); border: 1px solid #e2e8f0; overflow: hidden;">
                    <div style="padding: 20px; border-bottom: 1px solid #e2e8f0; background-color: #f8fafc;">
                        <h2 style="font-weight: 700; color: #000; display: flex; align-items: center; gap: 8px; font-size: 11px;">
                            <span style="font-size: 24px; color: #990dd1;">🏛️</span> GAD Mandates
                        </h2>
                        <p style="font-size: 10px; color: #3b3b3b; margin-top: 4px;" id="selectedReportInfo">Select an accomplishment report from the left panel</p>
                    </div>
                    <div style="padding: 20px; max-height: 500px; overflow-y: auto;" id="mandatesContainer">
                        <div style="text-align: center; color: #3b3b3b; padding: 40px 0;">
                            ...
                            <p style="font-size: 11px;">Select a report to view available mandates</p>
                        </div>
                    </div>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                    ...
                                    <span style="font-size: 11px; font-weight: 500; color: #000;">Select All Mandates</span>
                                </label>
                            </div>
                            <div id="selectedMandatesCount" style="font-size: 10px; color: #990dd1; font-weight: 500;">0 mandates selected</div>
                        </div>
                        <button id="setMandatesBtn" style="width: 100%; background-color: #990dd1; color: white; padding: 12px; border-radius: 12px; font-weight: 700; font-size: 11px; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                            <span style="font-size: 11px;">✅</span> Set Mandates
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div style="position: fixed; bottom: 16px; left: 224px; right: 0; text-align: center; pointer-events: none; z-index: 40;">
        <p style="font-size: 9px; color: rgba(59,59,59,0.2); font-weight: 500;">Benguet State University - Gender and Development Information Management System | GAD-IMS v1.0</p>
    </div>
    ...
    <div id="confirmationModal" style="position: fixed; top: 0; right: 0; bottom: 0; left: 0; background-color: rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center; z-index: 200; display: none;">
        <div style="background-color: white; border-radius: 16px; padding: 32px; max-width: 448px; width: 90%; margin: 0 16px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
            ...
            <div style="margin-bottom: 24px;">
                <p style="font-size: 11px; color: #3b3b3b; margin-bottom: 12px;">You are about to assign the following mandate(s) to:</p>
                ...
                <div style="margin-top: 16px;">
                    <p style="font-size: 11px; font-weight: 500; color: #000; margin-bottom: 8px;">Selected Mandates:</p>
            ...
            <div style="display: flex; gap: 12px;">
                <button onclick="confirmAssignment()" style="flex: 1; background-color: #990dd1; color: white; padding: 12px; border-radius: 12px; font-weight: 700; font-size: 11px; border: none; cursor: pointer;">Confirm</button>
                <button onclick="closeModal()" style="flex: 1; border: 1px solid #cbd5e1; padding: 12px; border-radius: 12px; font-weight: 700; font-size: 11px; background: none; cursor: pointer;">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function renderReportsList() {
            ...
            if (paginatedItems.length === 0) {
                container.innerHTML = '<div style="padding: 40px 24px; text-align: center; color: #3b3b3b; font-size: 11px;">No accomplishment reports found</div>';
            ...
            paginatedItems.forEach(report => {
                ...
                const statusBadge = (assignedCount > 0 || hasOther) ? '<span style="font-size: 9px; background-color: rgba(63,101,22,0.2); color: #3f6516; padding: 2px 8px; border-radius: 9999px;">Assigned</span>' : '<span style="font-size: 9px; background-color: rgba(236,210,36,0.2); color: #ecd224; padding: 2px 8px; border-radius: 9999px;">Unassigned</span>';
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                <div style="flex: 1;">
                                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                                        <span style="font-family: monospace; font-size: 10px; font-weight: 500; color: #990dd1;">${report.control}</span>${statusBadge}
                                    </div>
                                    <p style="font-weight: 500; color: #000; font-size: 11px;">${escapeHtml(report.title)}</p>
                                    <div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">
                                        <span style="font-size: 10px; color: #3b3b3b;">${escapeHtml(report.office)}</span>
                                        <span style="font-size: 10px; color: #3b3b3b;">•</span>
                                        <span style="font-size: 10px; color: #3b3b3b;">${report.date}</span>
                                    </div>
                                    ${assignedCount > 0 ? `<div style="font-size: 9px; color: #990dd1; margin-top: 4px;">${assignedCount} mandate(s) assigned</div>` : ''}
                                    ${hasOther ? `<div style="font-size: 9px; color: #990dd1; margin-top: 4px;">+ Other: ${escapeHtml(report.otherMandate)}</div>` : ''}
                                </div>
                                <span style="color: #3b3b3b; font-size: 11px;">→</span>
                            </div>
                        </div>`;
            });
        ...
        function updateReportsPagination(totalPages) {
            ...
            let buttonsHtml = `<button class="prev-report-btn" style="padding: 4px 8px; font-size: 10px; border: 1px solid #e2e8f0; border-radius: 8px; background: none; cursor: pointer;" ${currentReportPage === 1 ? 'disabled' : ''}>Prev</button>`;
            for (let i = 1; i <= Math.min(totalPages, 3); i++) buttonsHtml += `<button class="report-page-btn" style="padding: 4px 8px; font-size: 10px; border: 1px solid #e2e8f0; border-radius: 8px; ${currentReportPage === i ? 'background-color: #990dd1; color: white;' : 'background: none;'}" data-page="${i}">${i}</button>`;
            if (totalPages > 3) {
                buttonsHtml += `<span style="padding: 0 4px; font-size: 10px;">...</span>`;
                buttonsHtml += `<button class="report-page-btn" style="padding: 4px 8px; font-size: 10px; border: 1px solid #e2e8f0; border-radius: 8px; background: none;" data-page="${totalPages}">${totalPages}</button>`;
            }
            buttonsHtml += `<button class="next-report-btn" style="padding: 4px 8px; font-size: 10px; border: 1px solid #e2e8f0; border-radius: 8px; background: none; cursor: pointer;" ${currentReportPage === totalPages ? 'disabled' : ''}>Next</button>`;
        ...
        function renderMandatesList() {
            ...
            gadMandates.forEach(mandate => {
                html += `<label style="display: flex; align-items: flex-start; gap: 12px; padding: 12px; border-radius: 8px; cursor: pointer;">
                            ...
                            <span style="font-size: 11px; color: #3b3b3b; flex: 1;">${escapeHtml(mandate.title)}</span>
                        </label>`;
            });
            ...
            html += `<div style="border-top: 1px solid #e2e8f0; padding-top: 12px; margin-top: 8px;">
                        <label style="display: flex; align-items: flex-start; gap: 12px; padding: 12px; border-radius: 8px; cursor: pointer;">
                            ...
                            <span style="font-size: 11px; color: #3b3b3b; flex: 1; font-weight: 500;">Other (Please specify)</span>
                        </label>
                        <div class="ml-9 mt-2 ${isOtherChecked ? '' : 'hidden'}" id="otherTextContainer">
                            <textarea id="otherMandateText" rows="2" style="width: 100%; padding: 8px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 11px; font-family: inherit;" placeholder="Enter other mandate or special instruction...">${escapeHtml(otherMandateText)}</textarea>
                        </div>
                    </div>`;
            html += '</div>';
            container.innerHTML = html;
        ...
        document.getElementById('setMandatesBtn')?.addEventListener('click', () => {
            ...
            selectedMandatesList.forEach(m => {
                mandatesHtml += `<div style="display: flex; align-items: center; gap: 8px; font-size: 11px; color: #3b3b3b; padding: 4px 0;">
