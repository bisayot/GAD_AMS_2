...
const routes = [
  ...
  // College / TWG
  {
    ...
    children: [
      ...
      { path: 'submit', name: 'college-submit-hub', component: () => import('../views/college/SubmittView.vue') },
      ...
      { path: 'plan-and-budget', name: 'college-plan-and-budget', component: () => import('../views/admin/PlanAndBudgetView.vue') },
      { path: 'gad-plan-budget', name: 'college-gad-plan-budget', component: () => import('../views/college/GadPlanBudgetView.vue') },
  ...
  // Staff
  {
    ...
    children: [
      ...
      { path: 'plan-and-budget', name: 'staff-plan-and-budget', component: () => import('../views/admin/PlanAndBudgetView.vue') },
